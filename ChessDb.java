...
/**
 * Represents two ChessGames: A Night at the Opera and
...
public class ChessDb {
    ...
    /**
     * Creates a defualt instance of a chessgame
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * @return the List of the ChessGames
     */
    ...
    /**
     * returns the Morphy Isourd chessgame
     */
